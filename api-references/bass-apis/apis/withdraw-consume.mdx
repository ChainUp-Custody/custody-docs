...
description: "提币拉取接口, 此接口单次最多返回最近20条数据"
---
...
<ResponseField type="object[ ]">
    <Expandable title="object">
        <ResponseField name="trans_id" type="string">提现流水id</ResponseField>
        <ResponseField name="symbol" type="integer">币种名称</ResponseField>
        <ResponseField name="address_to" type="string">提币到账地址</ResponseField>
        <ResponseField name="amount" type="decimal">提现金额</ResponseField>
        <ResponseField name="memo" type="string">提现memo</ResponseField>
    </Expandable>
</ResponseField>
