...
欢迎来到CryptSafe资产托管平台，此文档用于第三方技术团队将自行开发的主链接入CryptSafe，以共享给联盟成员使用。

<Warning>
**注意**

使用WAPI接入主链，服务器与私钥都由第三方技术团队负责保管，CryptSafe不对资产的安全负责。所以第三方技术团队务必需要建立完善的私钥保管体系、API私钥保管体系。
</Warning>
