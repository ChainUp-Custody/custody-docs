...
<Expandable title="object">
    <ResponseField name="collect_sub_wallet_id" type="integer">归集金库，币种配置后获取</ResponseField>
    <ResponseField name="fueling_sub_wallet_id" type="integer">加油金库，币种配置后获取</ResponseField>
</Expandable>
