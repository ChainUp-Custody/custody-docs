...
description: "获取支持归集币种的归集子钱包及加油子钱包"
---
...
<Expandable title="object">
    <ResponseField name="collect_sub_wallet_id" type="integer">归集子钱包，币种配置后获取</ResponseField>
    <ResponseField name="fueling_sub_wallet_id" type="integer">加油子钱包，币种配置后获取</ResponseField>
</Expandable>
