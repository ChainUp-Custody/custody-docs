...
<ResponseField type="object[ ]">
    <Expandable title="object">
        ...
        <ResponseField name="status" type="integer">收款状态: 1000 未确认，1010待KYT验证, 1020 待KYT人工处理 1800 待溯源（等待系统溯源交易，保证交易安全性）， 1900 待验证溯源（交易完成溯源，等待系统验证交易），2000 已完成，3000 异常</ResponseField>
