...
<ParamField query="from" type="string">
    指定出币地址：从Keysecure获取到的用户地址或系统地址
</ParamField>
...
<ParamField query="sign" type="string">
   	使用RSA私钥签名, 参与签名的参数: "request_id", "sub_wallet_id", "symbol", "address_to", "amount", "memo", "outputs"。签名规则详见[Co-Signer交易签名验证](/api-references/mpc-apis/co-signer/sign-verify)
</ParamField>
