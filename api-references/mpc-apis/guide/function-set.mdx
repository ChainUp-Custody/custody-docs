...
Co-Signer内置生成RSA公私钥命令，仅限Co-Signer使用，请参考[Co-Signer配置](/quick-start/mpc-wallet/api-integration/co-signer)
</Tip>
...
* **交易审批回调地址**：请参考[Co-Signer配置](/api-references/mpc-apis/co-signer/callback/withdraw)
...
Co-Signer支持部署在普通服务器或 `支持SGX` 的服务器，为了安全起见，建议使用带有 SGX 的服务器；推荐微软云服务商；[查看Co-Signer服务器配置要求](/quick-start/mpc-wallet/api-integration/co-signer)
...
* [查看Co-Signer配置教程](/quick-start/mpc-wallet/api-integration/co-signer)
