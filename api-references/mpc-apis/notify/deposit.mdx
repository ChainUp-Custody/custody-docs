...
| status           | Integer | 是       | 收款状态包含以下几种：1000未确认，1010待KYT验证，1020待KYT人工处理，1800待溯源（保证交易安全），1900待验证溯源（溯源完成，等待系统验证），2000已完成，3000异常。[详细请参考](/help-center/manage-mpc/transaction/transfer#iii) |
