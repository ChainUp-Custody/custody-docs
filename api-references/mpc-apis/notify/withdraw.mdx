...
| fee              | String | 是       | 矿工费，例：0.00123                                          |
| real_fee         | String | 是       | 真实消耗的矿工费，例：0.00111                                |
...
| status           | Integer | 是       | 转账状态: 1000 未审批，1010 KYT验证中状态，1020 待KYT人工处理，1100 审批通过\待签名, 1200 支付中，2000 支付完成，2100 审批拒绝，2101 KYT验证拒绝，2200 拒绝, 2201 系统拒绝，2300 交易丢弃，2400 支付失败。[详细请参考](/help-center/manage-mpc/transaction/transfer#ii) |
