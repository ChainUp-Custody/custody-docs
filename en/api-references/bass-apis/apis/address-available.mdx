---
title: Available Address
api: POST /api/v1/address/available
description: "Number of addresses that are available in the pushed addresses"
---
<Tip>
It is recommended to monitor the script to determine the number of available addresses.
</Tip>
...
<Expandable title="object">
    ...
    <ResponseField name="count" type="integer">Number of addresses available</ResponseField>
</Expandable>
