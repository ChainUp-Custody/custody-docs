...
api: POST /api/v1/deposit/notify
...
<Expandable title="object">
    <ResponseField name="data" type="object">
        <Expandable title="object">
            <ResponseField name="request_id" type="string">Unique identifier for a single request</ResponseField>
        </Expandable>
    </ResponseField>
</Expandable>
...
<RequestExample>
  ```curl cURL
  curl -X POST \
  --url https://baas.waas.group/api/v1/deposit/notify \
  --data '{
