---
title: Callback Withdrawals Interface
api: POST /api/v1/withdraw/cancel
description: "To callback withdrawals."
---
...
<RequestExample>
  ```curl cURL
  curl -X POST \
  --url 'https://baas.waas.group/api/v1/withdraw/cancel' \
  --data '{
