---
title: Withdrawal
api: POST /api/v1/withdraw/consume
description: "This interface can return the latest 20 data at most at a time."
---
...
<ResponseField type="object[ ]">
    <Expandable title="object">
        <ResponseField name="trans_id" type="string">Withdrawal ID</ResponseField>
        <ResponseField name="symbol" type="integer">Token name</ResponseField>
        <ResponseField name="address_to" type="string">Withdrawal to account address</ResponseField>
        <ResponseField name="amount" type="decimal">Withdrawal Amount</ResponseField>
        <ResponseField name="memo" type="string">Withdraw memo</ResponseField>
    </Expandable>
</ResponseField>
...
<RequestExample>
  ```curl cURL
  curl -X POST \
  --url https://baas.waas.group/api/v1/withdraw/consume \
  --data '{
