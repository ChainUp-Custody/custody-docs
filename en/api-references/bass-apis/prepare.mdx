...
Welcome to the CryptSafe platform. This document is used by the third-party technical team to add the self-developed mainchain to the CryptSafe for alliance members.

<Note>
**Note**

When third-party technical team using WAPI to access the the server and keeping private keys, CryptSafe is not responsible for the security of assets. Therefore, the third-party technical team must establish a complete private key CryptSafe system and API private key CryptSafe system
</Note>
...
- **Party B** is the CryptSafe BaaS Cloud
