...
description: "Search the user’s account according to the coin and user ID. In addition, if the merchant starts auto sweeping operation, the user account will be transferred to the merchant’s omnibus wallet"
---
