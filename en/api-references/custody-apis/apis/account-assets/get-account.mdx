...
api: GET /api/v2/account/getByUidAndSymbol
description: "Search the user’s account according to the coin and user ID. In addition, if the merchant starts automatic consolidation, the user account will be transferred to the merchant’s consolidation account"
---
