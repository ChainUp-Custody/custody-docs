---
title: Balance of merchant consolidation account
api: GET /api/v2/account/getCompanyBySymbol
description: "After opening the automatic consolidation of merchant funds, the merchant can obtain the balance of merchant consolidation account through this interface"
---
...
<Expandable title="object">
    <ResponseField name="symbol" type="string">coin name</ResponseField>
    <ResponseField name="balance" type="string">collection account balance</ResponseField>
</Expandable>
