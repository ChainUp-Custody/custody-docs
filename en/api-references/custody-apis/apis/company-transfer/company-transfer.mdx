---
title: Custody Merchant Transfer
api: POST /api/v2/account/transfer
description: "ChainUp Custody merchants transfer money to each other"
---
...
<ParamField query="symbol" type="string" required>
    Transfer currency, Custody get currency name
</ParamField>
...
<ParamField query="to" type="string" required>
    Transfer in merchant, fill in merchant `APPID` at present
</ParamField>
...
<Expandable title="object">
    <ResponseField name="receipt" type="string">Unique voucher for transfer</ResponseField>
</Expandable>
