---
title: Address of the User-specified Coin
description: "To obtain the user specified coin account address. If there is no address, the user is assigned an address, and the account should not be generated. The account is still generated on demand."
---
...
<Expandable title="object">
    ...
    <ResponseField name="address" type="string">the coin account address</ResponseField>
</Expandable>
