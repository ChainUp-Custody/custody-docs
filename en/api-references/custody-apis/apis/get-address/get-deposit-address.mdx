...
description: "To obtain the user specified coin account address. If the user does not have an address, the system will automatically assign an address to the user."
---
