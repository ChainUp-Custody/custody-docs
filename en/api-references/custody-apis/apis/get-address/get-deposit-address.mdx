---
title: Address of the user-specified currency
api: POST /api/v2/account/getDepositAddress
...
<Expandable title="object">
    ...
    <ResponseField name="address" type="string">the currency account address</ResponseField>
</Expandable>
