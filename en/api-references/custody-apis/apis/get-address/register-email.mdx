...
api: POST /api/v2/user/registerEmail
description: "Register to become a wallet user, with email format (e.g. 123@111.com)"
---
...
<ParamField query="email" type="string" required>
    Email or Virtual Accounts, to ensure their uniqueness, up to 100 characters
</ParamField>
