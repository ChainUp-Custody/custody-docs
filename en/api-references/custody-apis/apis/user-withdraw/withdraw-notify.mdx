...
| status              | String | Required | Withdrawal status: 0 under review by risk control, 1 in payment, 2 audit rejection, 4 failed, 5 success, 6 cancelled , 7 pending KYT verification, 8 pending manual review (KYT risk level too high). [Details refer to](/help-center/manage-joint/account-transfer/transfer#ii) |
