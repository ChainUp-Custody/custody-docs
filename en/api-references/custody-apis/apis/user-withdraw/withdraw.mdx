...
description: "If the withdrawal address is the internal address of the Keysecure  Alliance, it will not be linked; In addition, in order to avoid illegal withdrawal requests, when the wallet service receives a withdrawal request from a third-party application, it will call the `Withdrawal Reconfirmation Interface` provided by the third party."
---
...
<ParamField query="remark" type="string">
    remark，Supports up to 300 characters
</ParamField>
