...
Follow the instructions below to access CryptSafe

For any questions, please contact your dedicated business manager or send email to service@cryptsafe.sg for assistance.
...
<Steps>
    ...
    <Step title="Download CryptoSafe App">

        Method 1：Open the link in your mobile browser：https://www.cryptsafe.sg/login
    ...
    <Step title="Register CryptoSafe account">
...
Open [CryptSafe platform](https://www.cryptsafe.sg/) using any browser, scan the QR code using 【CryptSafe】APP to login.

- Create a workspace

Enter the 【CryptSafe】 page and create a workspace.
