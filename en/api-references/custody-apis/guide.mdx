...
<Steps>
    ...
    <Step title="Download Keysecure App">
        ...
        Method 1：Open the link in your mobile browser：https://www.keysecure.io/download
...
Open [Keysecure platform](https://www.keysecure.io/login) using any browser, scan the QR code using 【Keysecure】APP to login.
