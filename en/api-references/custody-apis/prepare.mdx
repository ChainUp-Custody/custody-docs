...
Keysecure needs access to the **third-party applications** for second confirmation. Therefore, it's necessary to add the IP to the security group or whitelist of the Keysecure server. Below are the IP addresses for Custody:
