...
In the Custody system, there are three kinds of cost expenses in the tripartite system: `Sweeping Miner fees`, `Extracting miner fees`, and `profit-sharing` commission;
