---
title: Get Auto-Consolidation Sub-Wallets
api: GET /api/mpc/auto_collect/sub_wallets
description: "Retrieve the auto-consolidation sub-wallet and refueling sub-wallet for a specific coin."
---
...
<Expandable title="object">
    <ResponseField name="collect_sub_wallet_id" type="integer">Auto-consolidation sub-wallet, obtained after configuring the coin</ResponseField>
    <ResponseField name="fueling_sub_wallet_id" type="integer">Refueling sub-wallet, obtained after configuring the coin</ResponseField>
</Expandable>
