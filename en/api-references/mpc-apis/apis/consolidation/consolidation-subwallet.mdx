---
title: Get Auto-Sweep Wallets
api: GET /api/mpc/auto_collect/sub_wallets
description: "Retrieve the auto-sweep wallet and auto fueling wallet for a specific coin."
---
...
<Expandable title="object">
    <ResponseField name="collect_sub_wallet_id" type="integer">Auto-consolidation wallet, obtained after configuring the coin</ResponseField>
    <ResponseField name="fueling_sub_wallet_id" type="integer">Refueling wallet, obtained after configuring the coin</ResponseField>
</Expandable>
