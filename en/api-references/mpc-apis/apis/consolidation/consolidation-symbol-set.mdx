---
title: Configure Auto-Sweep for Coin
api: POST /api/mpc/billing/auto_collect/symbol/set
description: "Set the minimum auto-sweep amount and the maximum miner fee for refueling."
---
