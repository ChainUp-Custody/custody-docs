...
| Production Environment Domain (https://openapi.Keysecure.io/
) | Not applicable to the testing environment    |
| :------------------------------------------------------------------------ | ------------------------------------------------- |
...
| Param | Type   | Required | Description                                               |
| :---- | :----- | :------- | :-------------------------------------------------------- |
| data  | String | Required | `Data in JSON format` Encrypted string; encrypted with RSA private key, specific encryption information is described in the `Response Result Data Decryption Format` |
