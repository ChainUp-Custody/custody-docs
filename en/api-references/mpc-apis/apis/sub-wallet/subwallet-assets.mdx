---
title: Get Sub-Wallet Assets
api: GET /api/mpc/sub_wallet/assets
description: "Get the account assets under the specified sub-wallet and coin."
---
