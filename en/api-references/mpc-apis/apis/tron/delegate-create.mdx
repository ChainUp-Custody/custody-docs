...
<Warning>
    ...
    4.Obtain transaction records for purchasing Tron resources and use status to determine if the resource has been successfully represented(api-references/mpc-apis/apis/tron/delegate-record-list)
</Warning>
