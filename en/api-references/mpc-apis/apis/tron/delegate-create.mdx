...
<ParamField query="buy_type" type="integer">
    Resource purchase type 0: Energy and bandwidth, 1: Energy, default is 1 if not specified.
</ParamField>
<ParamField query="resource_type" type="integer" >
   Resource purchase method 0: System estimation - full delegation, 1: Specified quantity, 2: System estimation - supplementary delegation, default is 0 if not specified.
 <Note> 
