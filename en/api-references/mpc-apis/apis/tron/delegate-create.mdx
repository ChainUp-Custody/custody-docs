...
<ParamField query="address_from" type="string" required>
    The address that will receive the resources
        <Note>When buy_type=0 or 2, Please ensure that address_from holds the token corresponding to contract_dedress, otherwise the miner fee estimation will fail</Note>
</ParamField>
