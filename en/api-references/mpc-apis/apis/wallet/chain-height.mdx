...
description: "Get the latest block height of the specified main chain."
---
...
<Expandable title="object">
    <ResponseField name="height" type="long">Latest block height of the main chain</ResponseField>
</Expandable>
