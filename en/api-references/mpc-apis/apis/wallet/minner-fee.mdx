...
description: "Estimated mining fee for current currency transfer"
---
...
<ResponseField type="object[ ]">
    <Expandable title="object">
        <ResponseField name="feeSymbol" type="string">Fee currency, e.g. BSC</ResponseField>
        ...
        <ResponseField name="type" type="integer">Type, `0` main chain currency transfer, `1` token transfer</ResponseField>
        <ResponseField name="ifCollection" type="bool">Whether the currency supports collect, `true` supports it, `false` does not support it</ResponseField>
    </Expandable>
</ResponseField>
