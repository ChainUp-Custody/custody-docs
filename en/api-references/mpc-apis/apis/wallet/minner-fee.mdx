...
---
<Note>
UTXO-based networks are not supported at this time. The estimated miner fee returned by the API is for reference only; the actual miner fee is subject to the on-chain result.
</Note>
