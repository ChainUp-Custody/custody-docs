---
title: Web3 Transaction Speed Up
api: POST /api/mpc/web3/pending
description: "When a transfer is signed but has not been confirmed on the blockchain for a long time, it can be speed up by specifying a higher fee."
---
