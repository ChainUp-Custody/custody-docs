...
<ParamField query="sign" type="string">
   	RSA private key signature. Parameters involved in the signature: "request_id", "sub_wallet_id", "symbol", "address_to", "amount", "memo", "outputs". For signature rules, refer to [`Co-Signer Transaction Signature Verification`](/api-references/mpc-apis/co-signer/sign-verify)
</ParamField>
