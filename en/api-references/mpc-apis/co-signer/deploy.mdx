...
<Steps>
    ...
    custody_service:
        ...
        domain: "https://openapi.Keysecure .com/"
 ...
 **Method One: Co-Signer Generates Rsa Public and Private Keys**
    ...
    The private key is used to encrypt request parameters when requesting Keysecure service, and the corresponding public key needs to be configured to Custody. Custody uses this public key to decrypt Co-Signer request data.
 ...
 **Method Two: Client Generates Rsa Private Key and Imports into Co-Signer**
    ...
    This public key is provided by Custody, and Co-Signer uses this public key to decrypt the returned data from Keysecure services.
...
echo ""
APP_ID=""
echo "App id can find in https://custody.Keysecure .com/mpc/center/api."
...
echo ""
echo "Keysecure  RSA public key can find in https://custody.Keysecure .com/mpc/center/api"
