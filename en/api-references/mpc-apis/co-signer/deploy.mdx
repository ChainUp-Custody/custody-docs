...
echo ""
APP_ID=""
echo "App id can find in https://www.cryptsafe.sg/mpc/center/api."
...
echo ""
echo "ChainUp RSA public key can find in https://www.cryptsafe.sg/mpc/center/api"
...
CryptSafe needs access to the Co-Signer to create coequal private keys and generate addresses. Therefore, it's necessary to add the IP of the Co-Signer server to the security group or whitelist of the CryptSafe server. Below are the IP addresses for Custody:
