...
<Steps>
	...
	More details see: https://github.com/ChainUp-Custody/mpc-co-signer/blob/main/README_EN.md
  </Step>
  <Step title="Verification and next steps">
	    👉 The Co designer has completed configuration and successfully started, but initialization has not yet been completed. The next step is to go to the APP to perform a private key refresh operation to make the service available.
       <div className="w-full flex items-center justify-left">
            <CardGroup cols={5}>
