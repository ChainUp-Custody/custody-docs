...
<div className="w-full flex items-center justify-center">
    <img src="/images/apis/mpc-create-address_en.png" width="600"/>
</div>

## Automatic Signature (Callback Method)

<div className="w-full flex items-center justify-center">
    <img src="/images/apis/mpc-withdraw-callback_en.png" width="600"/>
</div>

## Automatic Signature (Signature Sign Verification Method)

<div className="w-full flex items-center justify-center">
    <img src="/images/apis/mpc-withdraw-sign_en.png" width="600"/>
</div>
