...
| 200082  | The wallet service is inactive   |
| 200105  | There are unfinished KYT manual review tasks   |
| 200121  | The transfer amount is less than the minimum transfer amount   |
| 200131  | Please activate the deposit address first   |
| 200164  | The TRON automatic proxy tool is in arrears and cannot transfer to an external address   |
