---
title: Receive Asynchronous Notification
---
...
| status           | Integer | Yes         | Receiving status: `1000` Unconfirmed, `1010` Pending KYT Verification, `1020` Pending KYT Manual Processing, `1800` Transaction Retrace, `1900` Withdrawal Unlock, `2000` Completed (Credited Completed), `3000` Abnormal, `4000` Returned. [Details refer to](/help-center/manage-mpc/transaction/transfer#iii)  |
...
| refund_amount    | String  | Yes         | Funds refund amount                                          |
