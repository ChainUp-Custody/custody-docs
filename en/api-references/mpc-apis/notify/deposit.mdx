...
| status           | Integer | Yes      | Receiving status: `1000` Unconfirmed, `1010` Pending KYT Verification, `1020` Pending KYT Manual Processing, `1800` Transaction Retrace, `1900` Withdrawal Unlock, `2000` Completed (Credited Completed), `3000` Abnormal. |
