...
<div className="w-full flex items-center justify-center">
    <img src="/en-us/images/apis/cusotdy-process_en.png" width="600"/>
</div>
...
<Steps>
    ...
    <Step title="Complete Identity Verification">
        ...
        <CardGroup cols={2}>
            <img src="/en-us/images/quickstart/login-auth1_en.png" width="200"/>
            <img src="/en-us/images/quickstart/login-auth2_en.png" width="200"/>
        </CardGroup>
        ...
        <div className="w-full flex items-center justify-center">
            <img src="/en-us/images/quickstart/login-set_en.png" width="200"/>
        </div>
    </Step>
