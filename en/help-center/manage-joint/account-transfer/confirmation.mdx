...
To further improve the speed of customer deposits, Keysecure has adjusted the confirmation numbers for supported networks.

## Obtian Confirmation Number

Customers can obtain the latest confirmation numbers through the following three methods:

1. Console (APP/WEB): Visit the deposit details page for the corresponding coin.
...
3. In the same network, the confirmation count for all coins is the same.
</Note>