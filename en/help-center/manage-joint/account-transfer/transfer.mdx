...
<div className="w-full flex items-center justify-center">
    <img src="/images/help-center/fullcustodytransfer-en.png" width="600"/>
</div>
...
- **Account Type** (e.g., ETH and ERC20 Token) requires each transaction to pay miner (gas) fees from the initiating account, so the system needs to periodically consolidate funds.
