...
Open the Keysecure App and switch to the MPC system. Select the "Assets" module at the bottom, and you can view the asset information of the default sub-wallet under management.
...
Access the Keysecure web version, and log in to the MPC system. After selecting the main wallet you want to manage, you will enter the "Sub-wallet" module by default, where you can view the asset information of each sub-wallet.
