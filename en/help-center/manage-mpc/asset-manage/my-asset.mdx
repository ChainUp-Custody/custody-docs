...
Open the CryptSafe App and switch to the MPC system. Select the "Assets" module at the bottom, and you can view the asset information of the default sub-wallet under management.
...
The Tokens module displays the asset information of main chain coins and tokens that the sub-wallet follows, including the quantity and USD value of each currency.

You can quickly find the required asset information by searching or switching the main network.

Clicking on a currency allows you to view the transaction information for that currency and perform convenient receipt and transfer operations.
...
Access the CryptSafe web version, and log in to the MPC system. After selecting the main wallet you want to manage, you will enter the "Sub-wallet" module by default, where you can view the asset information of each sub-wallet.
...
#### Select the Tokens Module
The Tokens module displays the asset information of main chain coins and tokens followed by the sub-wallet, including the quantity and USD value of each currency. You can perform convenient receipt and transfer operations.
