...
Log in to the [Smart Contract Platform](https://cold.keysecure.io), select the asset network you want to manage, and connect your third-party wallet to initiate the contract creation transaction.
<Note>
...
<div className="w-full flex items-center justify-center">
    <img src="/images/help-center/colewalletstep1en.jpeg" width="600"/>
</div>
...
<div className="w-full flex items-center justify-center">
    <img src="/images/help-center/lengqianbao1en.png" width="600"/>
</div>
...
<div className="w-full flex items-center justify-center">
    <img src="/images/help-center/heyuedizhien.png" width="600"/>
</div>
...
For warm wallet contracts: Keysecure recommends adding cold contract and hot wallet addresses to the whitelist to ensure smooth storage and transfer of funds between hot and cold wallets.
For cold wallet contracts: Keysecure recommends adding hot contract and hot wallet addresses to the whitelist to ensure smooth storage and transfer of funds between warm and hot wallets.

1. Visit the [Smart Contract Platform](https://cold.keysecure.io), select the network and contract to manage.
...
<div className="w-full flex items-center justify-center">
    <img src="/images/help-center/colewalletstep4en.png" width="600"/>
</div>
...
<div className="w-full flex items-center justify-center">
    <img src="/images/help-center/colewalletstep5en.png" width="600"/>
</div>
...
1. Go to the MPC Wallet Web Interface, select Cold Wallet > Funds Strategy, and click Add.
2. Choose the strategy coin, select the scheduling strategy, and fill in the appropriate parameters.

<Note>
Only the workspace owner and admins can edit asset flow strategies. For more information on editing fund scheduling strategies, please refer to [Funds Strategy](/user-guide/mpc-wallet/cold-wallet-manage/asser-flow).

<div className="w-full flex items-center justify-center">
    <img src="/images/help-center/diaoducelueen.png" width="600"/>
</div>
