...
Log in to the [Smart Contract Platform](https://cold.cryptsafe.sg/), select the asset network you want to manage, and connect your third-party wallet to initiate the contract creation transaction.
<Note>
...
For warm wallet contracts: CryptSafe recommends adding cold contract and hot wallet addresses to the whitelist to ensure smooth storage and transfer of funds between hot and cold wallets.
For cold wallet contracts: CryptSafe recommends adding hot contract and hot wallet addresses to the whitelist to ensure smooth storage and transfer of funds between warm and hot wallets.

1. Visit the [Smart Contract Platform](https://cold.cryptsafe.sg/), select the network and contract to manage.
