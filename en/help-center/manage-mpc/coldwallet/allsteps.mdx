...
Log in to the [Smart Contract Platform](http://cold.Keysecure .com), select the asset network you want to manage, and connect your third-party wallet to initiate the contract creation transaction.
<Note>
...
<div className="w-full flex items-center justify-center">
    <img src="/images/help-center/allstep1en.png" width="600"/>
</div>
...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/coldwalletasseten.png" width="600"/>
</div>
...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/contractlist1en.png" width="600"/>
</div>
...
1. Visit the [Smart Contract Platform](http://cold.Keysecure .com), select the network and contract to manage.
...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/whitelistpage1en.jpeg" width="600"/>
</div>
...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/vorefree1en.jpeg" width="600"/>
</div>
...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/contractpolicy1en.png" width="600"/>
</div>
