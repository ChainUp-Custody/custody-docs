...
**Distributed Asset Management**: When a user holds the same type of coin in multiple addresses or accounts, the API consolidation feature can integrate these scattered assets into a primary address or account, making it more convenient for management and monitoring.
...
##  Asset Types for Co-Signer Consolidation
...
##  Wallet Types for Consolidation
