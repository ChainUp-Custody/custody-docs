...
<Step title="Sign and Publish the Contract">
    The private key holder signs using the CryptoSafe App to scan the code, and the auto sweep rule is successfully published.
</Step>
</Steps>
...
<Step title="Open Sweep Tokens Feature">
    Log in and open the CryptoSafe App, switch to the MPC system, and open the "Discover - Sweep Tokens" function.
</Step>
...
Please use the CryptoSafe App's [Discover] - [Sweep Tokens] function, click to select the main wallet that has configured the sweeping contract for authorization.
</Warning>
