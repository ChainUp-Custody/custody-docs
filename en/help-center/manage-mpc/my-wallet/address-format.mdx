...
CryptoSafe also supports manually or API creating UTXO multiple addresses, with the second created address used as the change address to receive unused UTXO in transfers. [Learn more about change addresses](/help-center/manage-mpc/my-wallet/change-address).
...
To reduce the complexity of managing too many addresses, MPC Wallet supports auto sweep feature for MPC wallet's address. Currently, the supported protocols for address are as follows:

Protocols supporting address (I): BTC, BCH

Protocols supporting address (II): ETH, ARB, BSC, HECO, FEVM, ETC, MATIC, AVAX-C
