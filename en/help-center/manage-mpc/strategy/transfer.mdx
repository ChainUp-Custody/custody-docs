...
<div className="w-full flex items-center justify-center">
    <img src="/en/images/help-center/strategy-engine1en.PNG" width="800"/>
</div>
...
* Orders that match the basic policy require approval through the user-defined approval process to be granted.
