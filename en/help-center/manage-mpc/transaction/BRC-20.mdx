...
BRC-20 aims to establish a new standard for creating interchangeable tokens using the Bitcoin base layer. This document will elaborate on the basic concepts of BRC-20 transactions in CryptoSafe's MPC wallet, covering principles and use cases of receiving and transferring tokens.
...
CryptSafe's MPC Web3 wallet supports the receipt and transfer of BRC-20 tokens.

## Receiving BRC-20

<Note>
If you wish to receive BRC-20 tokens using the CryptoSafe wallet,
...
Based on the analysis of enterprise users and observations of operational behaviors, CryptoSafe believes that allowing most customers to manage their transferable and **available balances** themselves is complex and challenging. The core requirement of users is to be able to transact without understanding the transfer logic of BRC-20 tokens and to be able to transfer out all BRC-20 balances in their wallet at any time.

To minimize transmission blocks and reduce user operational processes, the BRC-20 transfer function of CryptoSafe's MPC wallet is **divided into the following two categories:**
...
Your maximum transfer inscription value = maximum available balance. For example, if your wallet's total balance is 1000 "ordi," and 700 "ordi" is transferable balance inscribed by a third party, then your wallet's maximum transfer inscription value is 300.
...
Your maximum transfer inscription value = maximum transferable balance. For example, if your wallet's total balance is 1000 "ordi," and you have inscribed 700 "ordi" using a third-party platform, then your wallet's maximum transfer value is 700.
