...
When a user initiates a withdrawal of digital assets either manually or via API, this transaction is referred to as a withdrawal. Withdrawal involves the process of transferring digital currency from your address to another target address. This may involve withdrawal operations initiated by you on the CryptSafe platform, sending digital currency to an external address.

### Deposit Transactions
When digital currency is transferred to your address from another address, this transaction is a deposit. Deposit involves the process of transferring digital currency from an external address to your CryptSafe address. This may occur when external users or platforms deposit digital currency to your CryptSafe address.

<Tip> 
* By clearly distinguishing between withdrawal and deposit, you can have a clearer understanding of the flow and transfer process of digital currency on the CryptSafe platform, aiding in accurate recording and monitoring of your digital assets.
</Tip>
