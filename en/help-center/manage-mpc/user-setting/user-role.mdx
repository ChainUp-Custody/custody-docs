...
Taking into account these factors, Custody MPC wallet roles are divided into three categories: Wallet Administrator, Approver, and Regular Member.
...
* Manage FIL nodes
* Authorize contracts and consolidate
* Configure Co-Signer
* Create KYT
* Handle KYT risks
* Approve members
...
### Approver
Approvers can approve transactions based on triggered transfer policies, and they also have the permissions of regular members.
...
* Handle KYT risks
* Configure contract consolidation policies
* Configure Co-Signer consolidation policies
...
### Regular Member
Regular members can initiate transactions, access allocated wallets, and query related information.
...
| Manage FIL Nodes | √ | × | × |
| Configure Contract Consolidation Rules | √ | √ | √ |
| Contract Consolidation Authorization | √ | × | × |
| Manual Contract Consolidation | √ | × | × |
| Create KYT Policies | √ | × | × |
| Handle KYT Risks | √ | √ | √ |
| Decide Co-Signer Wallets and Gas Stations | √ | × | × |
| Configure Co-Signer Consolidation Policies | √ | √ | √ |
