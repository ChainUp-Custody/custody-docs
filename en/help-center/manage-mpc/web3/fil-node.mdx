...
The Filecoin mining pool management tool of CryptSafe MPC system can be quickly accessed through the Filecoin mining pool management icon on the wallet interface.
