...
##  Activate Compliant Custody KYT Service
...
<Step title="Choose the KYT Service Provider">
   If you intend to activate the KYT service, the service providers that CryptSafe can integrate with include:
...
**KYT Service Hosting**: Activate the required KYT service through CryptSafe, and Custody will assist in activating the KYT account. Users can renew services or switch service providers through Custody at any time.
