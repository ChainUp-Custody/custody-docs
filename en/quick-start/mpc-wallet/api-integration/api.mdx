...
Keysecure provides powerful and easy-to-integrate API tools to automate your workflow, quickly create and configure wallets, and receive various wallet-related information.

##  What Can I Do with Keysecure API?
...
You can easily configure the API information for the MPC System on the Keysecure Web version for more flexible wallet management.
...
In the Keysecure Web(Web) version, use the "**API Management**."
