...
## II. What Can I Do with ChainUp Custody API?
...
You can easily configure the API information for the MPC wallet on the Custody PC version for more flexible wallet management.

<Warning>
**Important Note**

An MPC main wallet can only configure one API. To ensure the functionality of the API, API configuration needs to be synchronized with Co-Signer configuration.

Only the wallet creator can configure API information, and editing requires GA verification.
...
By configuring the API information for the MPC wallet, you will be able to use API features more conveniently, enabling more flexible and efficient digital asset management.
</Warning>

### III.I. API Management

In the Custody PC(Web) version, use the "**API Management**."

Create or edit API information for the MPC wallet and then successfully modify it through GA verification.

### III.II. Configuration Fields
...
Provide additional configuration instructions or labels. This field is usually used to record additional information related to API configuration, making it easy for administrators and developers to understand special requirements or agreements associated with the configuration.
