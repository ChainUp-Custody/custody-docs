...
CryptSafe provides powerful and easy-to-integrate API tools to automate your workflow, quickly create and configure wallets, and receive various wallet-related information.

##  What Can I Do with CryptSafe API?
...
You can easily configure the API information for the MPC System on the CryptSafe Web version for more flexible wallet management.
...
In the CryptSafe Web(Web) version, use the "**API Management**."
