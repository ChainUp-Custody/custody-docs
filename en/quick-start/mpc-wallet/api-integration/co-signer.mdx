...
<Steps>
  ...
  ```
     ...
     <Step title="Co-Signer configures the public key used to verify the signature when not calling back to the client system">
        ...
        You can access MPC System on PC and us "API Management" feature to view RSA public key and other field information.

        <div className="w-full flex items-center justify-center">
    <img src="/en/images/quickstart/rsainforen1.jpeg" width="500"/>
</div>
<div className="w-full flex items-center justify-center">
    <img src="/en/images/quickstart/rsainforen2.jpeg" width="300"/>
</div>
