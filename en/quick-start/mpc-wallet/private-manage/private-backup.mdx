...
<Step title="Open Private Key Backup Feature">
    Open the **Security** feature, select the workspace, and manually backup the private key.
</Step>
...
<Step title="Select Cloud Drive">
    ...
    <Warning>
1. The folder name in your cloud drive where Keysecure MPC System backs up files is "do not delete Custody backup." Please make sure not to delete the folder and files within it.
