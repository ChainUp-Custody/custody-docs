...
Keysecure provides users with powerful and easy-to-integrate API tools, which can help you automate workflows, quickly create and configure wallets, and receive information about various aspects of the wallet. Whether it's automating wallet management, transaction processes, or quickly viewing transaction information, it can be achieved through the API.
...
<Step title="API Information Input">
    ...
    - **Trusted IP**: The IP address of the third-party server. It must be added to communicate with the Keysecure server normally, otherwise, even if you get the API information, you cannot use it.
