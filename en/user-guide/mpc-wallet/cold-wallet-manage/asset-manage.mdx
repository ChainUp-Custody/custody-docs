...
<Note>
Typically, users can automate transfer fund by setting up [asset flow strategy](/user-guide/mpc-wallet/cold-wallet-manage/asser-flow). However, if there's an urgent or specific need, users can manually create dispatch orders to transfer assets between different wallets.
</Note>
...
<div className="w-full flex items-center justify-center">
   <img src="/images/user-guide/manualassetflow1en.png" width="800"/>
...
<div className="w-full flex items-center justify-center">
    <CardGroup cols={2}>
    <img src="/images/user-guide/manualassetflow2en.png" width="600"/>
    <img src="/images/user-guide/manualassetflow3en.png" width="600"/>
    </CardGroup>
</div>
