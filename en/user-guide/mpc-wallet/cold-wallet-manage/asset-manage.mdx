...
The cold wallet function of the Keysecure MPC Wallet provides users with comprehensive fund management and scheduling capabilities, including:
...
<Tip> 
The system defaults to setting the Omnibus wallet as a hot wallet. If you want to modify the hot wallet, please visit the [Auto Sweep](/user-guide/mpc-wallet/consolidate/co-signer/rules) feature to make changes.
</Tip>

2. Manually Initiate Asset Flowing Tasks: Users can manually initiate asset flowing tasks, such as warm-to-hot, warm-to-cold, hot-to-warm, etc., to achieve flexible fund scheduling and management.
...
<Note>
Typically, the cold wallet solution needs to be used in conjunction with the API and aggregation function. The Keysecure System recommends that you complete the following operations before using the cold wallet function:
1. Enable [API Co-Signer](/user-guide/mpc-wallet/api-integration/co-signer)
2. Configure the [omnibus wallet and gas station](/user-guide/mpc-wallet/consolidate/co-signer/rules)
3. Edit and enable the [auto sweeping strategy](/user-guide/mpc-wallet/consolidate/co-signer/rules)
</Note>
...
1. No hot wallet address: Confirm whether the hot storage wallet has successfully followed the coin.
...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/截屏2025-07-02 14.55.17.png" width="800"/>
</div>
...
<Note>
Typically, users can automate transfer fund by setting up [Funds Strategy](/user-guide/mpc-wallet/cold-wallet-manage/asser-flow). However, if there's an urgent or specific need, users can manually create dispatch orders to transfer assets between different wallets.
</Note>
...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/截屏2025-07-02 14.55.48.png" width="800"/>
</div>
...
<div className="w-full flex items-center justify-center">
   <img src="/images/user-guide/截屏2025-07-02 14.55.57.png" width="800"/>

</div>

<div className="w-full flex items-center justify-center">
   <img src="/images/user-guide/截屏2025-07-02 14.56.06.png" width="800"/>
...
The Keysecure System will default to setting the aggregation wallet of the workspace as the hot wallet. If you want to modify it, please choose the wallet responsible for daily trading deposits and withdrawals according to your daily business needs, or a wallet that centrally manages all asset storage under the workspace, and configure it as an aggregation wallet on the [Automatic Aggregation] function page.
</Accordion>
...
1. The currently selected hot wallet has not generated a coin address.
