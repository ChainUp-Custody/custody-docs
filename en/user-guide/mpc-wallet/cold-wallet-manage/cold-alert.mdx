...
The Custody system supports monitoring the following scenarios:

1. Balance Monitoring
Proposal transactions initiated by vote-free addresses do not require signer approval and are automatically passed. Since these transactions require the vote-free address to pay gas fees, it is necessary to maintain a certain amount of the native cryptocurrency. Insufficient native currency balance will cause transaction failure, affecting the automated scheduling of assets. The Custody system monitors the balance of vote-free addresses on the warm wallet based on the user's configured contract network. If the balance falls below the threshold, an alert is triggered.
<Tip> 
...
2. Asset Transfer Task Monitoring
...
You can add up to 10 email addresses.
 ...
 <div className="w-full flex items-center justify-center">
    <CardGroup cols={2}>
    <img src="/images/user-guide/alert1en.png" width="400"/>
    <img src="/images/user-guide/alert2en.png" width="400"/>
    </CardGroup>
</div>
...
2. Edit the monitoring threshold: The system default value is displayed by default, but users can customize it to 4 decimal places.
 <div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/alert3en.png"/>
</div>
