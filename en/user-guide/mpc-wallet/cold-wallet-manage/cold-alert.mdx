...
The Keysecure System supports monitoring the following operational scenarios for cold wallet functions:

1. Balance Monitoring
Proposal transactions initiated by vote-free addresses do not require signer approval and are automatically passed. Since these transactions require the vote-free address to pay gas fees, it is necessary to maintain a certain amount of the native crypto coin. Insufficient native coin balance will cause transaction failure, affecting the automated scheduling of assets. The Keysecure System monitors the balance of vote-free addresses on the warm wallet based on the user's configured contract network. If the balance falls below the threshold, an alert is triggered.
<Tip> 
...
The Keysecure System monitors the status of warm-to-hot and hot-to-warm transfer tasks and notifies users of key events.
...
You can add up to 10 email addresses.
 ...
 <div className="w-full flex items-center justify-center">
    <CardGroup cols={2}>
    <img src="/images/user-guide/截屏2025-07-02 15.00.47.png" width="600"/>
    <img src="/images/user-guide/截屏2025-07-02 15.01.03.png" width="600"/>
    </CardGroup>
</div>
...
2. Edit the monitoring threshold: The system default value is displayed by default, but users can customize it to 4 decimal places.
 <div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/截屏2025-07-02 15.01.13.png" width="800"/>
</div>
