...
<Step title="Configure message notification">

If your consolidation business lacks the required handling fee main chain coin, the Custody system will send you a notification email to ensure that you understand and take necessary actions in time. Once the system detects that the consolidation business lacks the required handling fee main chain coin, it will send a reminder email to the set notification email.
<div className="w-full flex items-center justify-center">
