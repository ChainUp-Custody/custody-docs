...
<Step title="Configuring Omnibus Wallet and Gas Station">
   Use the CryptoSafe App to scan the QR code and configure the Omnibus Wallet and Gas Station through the "Auto Sweep" feature on the CryptSafe Web platform.
...
Use the CryptoSafe App to scan the provided QR code and sign with local private key shares to confirm the configuration of the Omnibus Wallet and Gas Station.
 <div className="w-full flex items-center justify-center">
    <CardGroup cols={2}>
