...
**1. Create and publish consolidation contracts**

**2. Configure consolidation assets**

**3. Contract authorization**

### Create and Publish Consolidation Contracts

<Steps>
<Step title="Create and publish consolidation contracts">
    Select "Consolidation Management" in the MPC Web interface, and click "+" to create a consolidation contract.
...
<Step title="Select the sub-wallet for consolidation">
   <div className="w-full flex items-center justify-center">
...
<Step title="Edit consolidation threshold">
    Click "Edit Consolidation" on the Consolidation Management page, then click "+" on the editing page to add the consolidation currency.
<div className="w-full flex items-center justify-center">
<CardGroup cols={2}>
...
In the Custody APP, go to 【Discover】-【MPC Token Consolidation】, click to select the main wallet that has configured the consolidation contract for authorization.
