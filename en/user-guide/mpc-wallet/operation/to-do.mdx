...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/daibanen.png" width="600"/>
</div>
...
<div className="w-full flex items-center justify-center">
    ...
    <img src="/images/user-guide/yibanen.png" width="650"/>
</div>
...
Sorry, we currently do not support users to perform Fil-related pending operations on the MPC PC platform. You can view and handle Fil-related pending tasks through the CryptSafe App.
</Accordion>