...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/todoappen.jpeg" width="200"/>
</div>
...
**Workspace creators and administrators** can cancel transactions, sign transactions, accelerate transactions, etc. 

**Workspace administrators** can also receive equal-rights private keys in this module.
...
2. For any operation that requires a private key signature, you can use the ChainUp Custody App with locally backed up private keys to scan the QR code.
</Warning>
...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/doneappen.jpeg" width="150"/>
    <img src="/images/user-guide/doneweben.jpeg" width="650"/>
</div>
...
<Accordion title="As a workspace administrator, can I recover and backup the private key myself?"> 
Workspace administrator cannot recover the private key. You need to contact the workspace creator to resend the private key. 
</Accordion>
...
Sorry, we currently do not support users to perform Fil-related pending operations on the MPC PC platform. You can view and handle Fil-related pending tasks through the Custody APP.
</Accordion>