...
**Workspace creators and admins** can cancel transactions, sign transactions, accelerate transactions, etc. 

**Workspace admins** can also receive equal-rights private keys in this module.
...
<Accordion title="As a workspace admin, can I recover and backup the private key myself?"> 
Workspace admin cannot recover the private key. You need to contact the workspace creator to resend the private key. 
</Accordion>
