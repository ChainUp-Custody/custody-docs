...
<Step title="Log in and Open Strategy Engine">
    Use the CryptSafe App to scan and log in to the MPC wallet web version, select the [Strategy Engine - Wallet Strategy] module, and choose the wallet [Basic Strategy] module.
<div className="w-full flex items-center justify-center">
<img src="/images/user-guide/walletbasic strategy1en.png" width="600"/>
</div>
</Step>
...
<div className="w-full flex items-center justify-center">
  ...
  <img src="/images/user-guide/walletbasic strategy3en.png" width="600"/>

</div>

<div className="w-full flex items-center justify-center">

  <img src="/images/user-guide/walletbasic strategy4en.png" width="600"/>
...
<div className="w-full flex items-center justify-center">
    <CardGroup cols={2}>
        <img src="/images/user-guide/walletbasic strategy5en.png" width="600"/>
      <img src="/images/user-guide/walletbasic strategy6en.png" width="600"/>
        </CardGroup>
</div>
</Step>
</Steps>
