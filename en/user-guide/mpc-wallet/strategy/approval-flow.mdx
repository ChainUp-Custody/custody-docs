...
<Step title="Log in and Open Strategy Engine">
    Use the CryptoSafe App to scan and log in to the MPC wallet web version, select the [Strategy Engine - Wallet Strategy] module, and choose the wallet [Basic Strategy] module.
