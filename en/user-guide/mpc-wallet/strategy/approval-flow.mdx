...
<Step title="Log in and Open Transfer Strategy">
    Use the Custody APP to scan and log in to the MPC wallet web version, select the [Strategy Engine] module, and choose the wallet [Basic Strategy] module.
...
The default basic strategy for all MPC wallets requires creator approval. Users can add other wallet members for joint approval according to the organization's equity requirements.

As the last line of defense for wallet security, the basic strategy cannot be deleted. Once modified, changes to the basic strategy will be applied to all risk control scenarios. If you need more dimensional control over wallet transactions, consider configuring advanced strategies.

</Tip>
<div className="w-full flex items-center justify-center">

  <img src="/en/images/user-guide/basicstrategy.png" width="400"/>
...
<div className="w-full flex items-center justify-center">
    <CardGroup cols={2}>
        <img src="/en/images/user-guide/confirmeditvasic2.png" width="400"/>
...
As the last line of defense for wallet security, the basic strategy cannot be deleted.
</Accordion>
...
All co-managing members of the wallet, including creators, administrators, and regular members, can view and edit the wallet's basic strategy.
</Accordion>
<Accordion title="How to view the history of basic strategy edits">
You can click the operation records button in the upper right corner to view all the strategy edit records of the wallet.
</Accordion>