...
<Note>
The workspace owner can add or remove workspace admins through [Workspace Member](/user-guide/mpc-wallet/wallet/add-user).

<div className="w-full flex items-center justify-center">
        <img src="/images/user-guide/wmemberen.png" width="200"/>
</div>
...
<div className="w-full flex items-center justify-center">
        <img src="/images/user-guide/keytodoen.jpeg" width="200"/>
</div>
