...
The Filecoin mining pool management tool of the Keysecure MPC Workspace can be quickly accessed and used through the Filecoin mining pool management icon on the workspace interface.
...
In the MPC Workspace Filecoin mining pool management tool, there are the following states:
