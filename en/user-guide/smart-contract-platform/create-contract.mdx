...
On the Keysecure's [smart contract platform](https://cold.keysecure.io), you can link third-party wallets and create warm or cold wallet contracts across different networks.
...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/designcontracten.jpeg" width="800"/>
</div>
...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/createcontractsignen.jpeg" width="800"/>
</div>
...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/waitingcreatiionen.jpeg" width="800"/>
</div>
