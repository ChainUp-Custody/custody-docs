...
1. 查看资金详情：用户可以查看当前热钱包、温钱包、冷钱包的资金详情，包括各钱包的资产分布和余额情况。
2. 修改热钱包：用户可以根据实际需求修改热钱包的配置，以适应不同的资金调度策略。
3. 手动发起资金调度任务：用户可以手动发起资金调度任务，如温转热、温转冷、热转温等，实现资金的灵活调度和管理。
...
<div className="w-full flex items-center justify-center">
    <img src="/en/images/user-guide/coldwalletassetcn.png" width="200"/>
</div>
...
<div className="w-full flex items-center justify-center">
   <img src="/images/user-guide/manualflow1cn.png" width="400"/>
...
<div className="w-full flex items-center justify-center">
    <CardGroup cols={2}>
    <img src="/images/user-guide/manualflow2cn.png" width="400"/>
    <img src="/images/user-guide/manualflow3cn.png" width="400"/>
    </CardGroup>
</div>
