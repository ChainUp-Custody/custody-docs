...
<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/截屏2025-07-02 15.02.47.png" width="800"/>
</div>
...
<div className="w-full flex items-center justify-center">
   <img src="/images/user-guide/截屏2025-07-02 15.02.57.png" width="800"/>
...
<div className="w-full flex items-center justify-center">
    <CardGroup cols={2}>
    <img src="/images/user-guide/截屏2025-07-02 15.03.08.png" width="600"/>
    <img src="/images/user-guide/截屏2025-07-02 15.04.00.png" width="600"/>
    </CardGroup>
</div>
