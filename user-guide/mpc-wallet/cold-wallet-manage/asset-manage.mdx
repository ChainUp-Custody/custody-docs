...
CryptSafe MPC钱包的冷钱包功能为用户提供了全面的资金管理和调度能力，具体功能包括：
...
<Note>
通常，冷钱包方案需要配合API和归集功能共同使用。CryptSafe系统建议您先完成以下操作再使用冷钱包功能:
...
<Steps>
<Step title="配置热存储钱包">
登录CryptSafe Web端，访问【冷钱包】功能。初次使用时，请先确定是否已完成【自动归集】-【归集钱包和加油站】的配置，系统将默认选择归集钱包作为热钱包选择工作站下的某一钱包，该钱包的常用地址将用于存储您的资产，并与温钱包和冷钱包进行交互，实现资产的分布式存储与资金的自动化流转。

<Note>
CryptSafe系统建议交易所客户选择归集钱包作为热存储钱包。
</Note>

<div className="w-full flex items-center justify-center">
    <img src="/images/user-guide/coldwalletassetcn.png" width="800"/>
</div>
