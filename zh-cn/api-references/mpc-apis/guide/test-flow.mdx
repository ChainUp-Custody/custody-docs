...
<div className="w-full flex items-center justify-center">
    <img src="/zh-cn/images/apis/mpc-get-address_cn.png" width="600"/>
</div>
...
<div className="w-full flex items-center justify-center">
    <img src="/zh-cn/images/apis/mpc-user-deposit_cn.png" width="600"/>
</div>
...
<div className="w-full flex items-center justify-center">
    <img src="/zh-cn/images/apis/mpc-user-withdraw_cn.png" width="600"/>
</div>